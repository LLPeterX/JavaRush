...
public class FunctionalTest {
    ...
    public void testStorage(Shortener shortener){
        ...
        String rstr1  = shortener.getString(id1);
        String rstr2  = shortener.getString(id2);
        String rstr3  = shortener.getString(id3);

        Assert.assertEquals(s1, rstr1);
        Assert.assertEquals(s2, rstr2);
        Assert.assertEquals(s3, rstr3);
    }
