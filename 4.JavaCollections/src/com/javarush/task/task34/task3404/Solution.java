...
public class Solution {
    ...
    public void recurse(final String expression, int countOperation) {
        ...
        int inside = 0; // уровень скобок (0-вне скобок)
        int p1 = -1, p2 = -1, p3 = -1;
        char[] s = value.toCharArray(); // исх.выражение в виде массива символов
        for (int i = s.length - 1; i >= 0; i--) { // цикл с конца и до начала
            switch (s[i]) {
                case '^':
