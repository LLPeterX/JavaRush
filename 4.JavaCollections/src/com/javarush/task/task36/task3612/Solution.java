...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        solution.initializeDates(); // после этого lastDate = 9999999L
    ...
    private void initializeDates() {
        dates = new HashSet<>();
        lastDate = new Date(9999999L); // типа, последняя дата, т.к. она больше других
        dates.add(lastDate);
    ...
    protected void updateLastDate(long delta) {
        // удаляем старую дату lastDate и заносим новую
