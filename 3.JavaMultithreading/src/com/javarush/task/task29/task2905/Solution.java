        ...
        for (int i = 0; i < NUMBER_OF_THREADS; i++) {
            new Thread() {
                ...
                public void run() {
                    while (true) {
                        try {
                            // drainTo() Удаляет все доступные элементы из этой очереди и добавляет их к данному набору.
                            //messageQueue.drainTo(messageQueue, MAX_BATCH_SIZE); // тут exception (ошибка)
