...
public class Dog implements Pet {
     ...
     * Пример, " *** Барбос *** "
     * Логика метода say:
     * Если i < 1, то используя метод getName вывести на экран, что собака спит. Пример,
     * " *** Шарик ***  спит."'
     * " *** Шарик ***  спит.
     * Иначе вывести фразу: "имя_собаки лает гааав! сегодняшняя_дата". Пример для i=3,
     * " *** Тузик ***  лает гааав! 13-ноя-2013 Ср"
     * " *** Тузик ***  лает гав! 27-авг-2019 Вт
        ...
        class DogPet extends SuperDog implements Sayable {
            ...
            public String say() {
                ...
                if(i<1) {
                    ...
                    //sb.append(sup.formatter.format(new Date()));
                    //return sb.toString();
                }
            }
        }
