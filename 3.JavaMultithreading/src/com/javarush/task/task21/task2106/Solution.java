...
public class Solution {
    ...
    public boolean equals(Object o) {
        ...
        // Важно:
        // - прмитивы сравниваем как есть
        // - объекты (String в т.ч.) только через Objects.equals()
        // - hash вычисляек только ч/з Objects.hash()
...
/*
    ...
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof Solution)) return false; // 1
...
*/
    ...
    */
    public static void main(String[] args) {
        //public Solution(int anInt, String string, double aDouble, Date date, Solution solution) {
        Date d = new Date();
        Solution s1 = new Solution(12,"peter",13.456,d,null);
        Solution s2 = new Solution(12,"peter",13.456,d,null);
